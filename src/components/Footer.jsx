            ...
            <div className=" mx-auto">
                ...
                <div className="pt-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-xs">
                    ...
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        <a href="/polityka-prywatnosci" className="hover:text-secondary-color transition-colors">
                            Polityka Prywatności
                        </a>
                        <a href="/regulamin" className="hover:text-secondary-color transition-colors">
                            Regulamin
                        </a>
                    </div>
                </div>
